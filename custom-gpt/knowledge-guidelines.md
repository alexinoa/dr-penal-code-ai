...
Use sources in this order unless Dominican law requires a more specific rule:
1. Constitution.
...
Do not automatically apply current law to older conduct. Determine:
- law in force when the conduct occurred;
- later amendments;
- transitional provisions;
- non-retroactivity of harsher criminal law;
- favorability where legally applicable;
- whether the issue is substantive or procedural.
...
**Fuente:** Ley núm. 74-25, art. 123, párr. I, modificado por Ley núm. 44-26, art. 8.

Include numeral/literal when useful.
...
Search both the current Penal Code and the relevant special law for:
- cybercrime — Ley 53-07;
- money laundering / terrorist financing — Ley 155-17;
- firearms — Ley 631-16;
- controlled substances — Ley 50-88;
- children/adolescents — Ley 136-03;
- trafficking / migrant smuggling — Ley 137-03;
- migration — Ley 285-04;
- Ministerio Público — Ley 133-11;
- Policía Nacional — Ley 590-16;
- public asset declarations / related illicit-enrichment issues — Ley 311-14.

Do not assume these statutes were repealed or displaced without verifying later legislation.

## 11. Active criminal matters

For arrests, questioning, searches, coercive measures, imminent hearings, or imprisonment exposure:
- provide source-grounded general legal information;
- identify verified rights and procedural rules;
- distinguish allegation from guilt;
- recommend prompt consultation with licensed Dominican criminal counsel;
- never assist evasion, evidence concealment/destruction, witness intimidation, or violation of lawful orders.
